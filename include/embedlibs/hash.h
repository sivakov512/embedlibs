...
#define HASH32_MULT_KNUTH 2654435761U // NOLINT(modernize-macro-to-enum)

#define HASH32_MUR_FMIX1 0x85EBCA6BU // NOLINT(modernize-macro-to-enum)
#define HASH32_MUR_FMIX2 0xC2B2AE35U // NOLINT(modernize-macro-to-enum)
